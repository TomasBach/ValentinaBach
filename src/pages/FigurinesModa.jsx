...
const FigurinesModa = () => {
    return (
        <>
            <ModeloTrabajo Titulo={"Figurines de Moda"} QueIncluyen={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum aliquid officia quasi sed non nisi optio fuga voluptatibus, error consequatur unde earum libero ex voluptates. Ratione quo optio beatae dolores!"}
